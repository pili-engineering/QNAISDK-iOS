 ...
 * @since v2.0.0
 */
- (void)RTCEngine:(QNRTCEngine *)engine didSubscribeTracks:(NSArray<QNTrack *> *)tracks ofRemoteUserId:(NSString *)userId;
 ...
 * @since v2.5.0
 */
- (void)RTCEngine:(QNRTCEngine *)engine didSubscribeProfileChanged:(NSArray<QNTrack *> *)tracks ofRemoteUserId:(NSString *)userId;
 ...
 * @since v2.0.0
 */
- (void)RTCEngine:(QNRTCEngine *)engine didPublishTracks:(NSArray<QNTrack *> *)tracks ofRemoteUserId:(NSString *)userId;
 ...
 * @since v2.0.0
 */
- (void)RTCEngine:(QNRTCEngine *)engine didUnPublishTracks:(NSArray<QNTrack *> *)tracks ofRemoteUserId:(NSString *)userId;
 ...
 *
 * @discussion 需要加入房间成功后且不处于重连状态才可以发布音视频。调用该接口后，SDK 会默认创建一个音频 QNTrack 和一个视频 QNTrack
 * 并发布，其中 master 属性均被置为 YES，master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
- (void)publish;
 ...
 *
 * @discussion 需要加入房间成功后且不处于重连状态才可以发布音频。调用该接口后，SDK 会默认创建一个音频 QNTrack 并发布，其中 master 属性会置为 YES，
 * master 属性含义可查阅 QNTrack.h 头文件。
 *
 *
 * @since v2.0.0
 */
 ...
 *
 * @discussion 需要加入房间成功后且不处于重连状态才可以发布视频。调用该接口后，SDK 会默认创建一个视频 QNTrack 并发布，其中 master 属性会置为 YES，
 * master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
 ...
 * @since v2.0.0
 */
- (void)publishTracks:(NSArray<QNTrack *> *)tracks;

/*!
 * @abstract 取消发布本地的音视频。
 *
 * @discussion 该接口会取消发布 master 属性为 YES 的 Track，master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
- (void)unpublish;
 ...
 * @abstract 取消发布本地的音频。
 *
 * @discussion 该接口会取消发布 master 属性为 YES 的音频 Track，master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
- (void)unpublishAudio;
 ...
 * @abstract 取消发布本地的视频。
 *
 * @discussion 该接口会取消发布 master 属性为 YES 的视频 Track，master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
- (void)unpublishVideo;
 ...
 * @discussion QNTrack 中只需要设置需要取消发布的 trackId 即可，其它参数可忽略。
 *
 * @since v2.0.0
 */
- (void)unpublishTracks:(NSArray<QNTrack *> *)tracks;

/*!
 * @abstract 将本地音频置为 muted 状态。
 *
 * @discussion 需要发布成功后才可以执行 mute 操作。该接口只会操作标识为 master 的音频 Track，master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
 ...
 *
 * @discussion 需要发布成功后才可以执行 mute 操作。该接口只会操作标识为 master 的视频 Track，master 属性含义可查阅 QNTrack.h 头文件。
 *
 * @since v2.0.0
 */
 ...
 *
 * @discussion 需要发布成功后才可以执行 mute 操作。将需要操作的 trackId 及 muted 状态设置到 QNTrack 中，QNTrack 其它参数可忽略。
 *
 * @since v2.0.0
 */
- (void)muteTracks:(NSArray<QNTrack *> *)tracks;
...
/*!
 * @abstract 订阅由 QNTrack 中的 trackId 指定的一组 Track。
 *
 * @discussion 此处 QNTrack 只须设置 trackId，其它参数可忽略。
 *
 * @since v2.0.0
 */
- (void)subscribeTracks:(NSArray<QNTrack *> *)tracks;

/*!
 * @abstract 取消订阅由 QNTrack 中的 trackId 指定的一组 Track。
 *
 * @discussion 此处 QNTrack 只须设置 trackId，其它参数可忽略。
 *
 * @since v2.0.0
 */
- (void)unsubscribeTracks:(NSArray<QNTrack *> *)tracks;

/*!
* @abstract 更新订阅由 QNTrack 中的 trackId 指定的一组 Track。
*
* @discussion 用于订阅大小流。
*
* @since v2.5.0
*/
- (void)updateSubscribeTracks:(NSArray<QNTrack *> *)tracks;
 ...
 * @since v3.0.1
 */
- (void)setLocalVideoSEI:(NSString *)videoSEI repeatNmuber:(NSNumber *)repeatNumber withTracks:(NSArray<QNTrack *> *)tracks;
