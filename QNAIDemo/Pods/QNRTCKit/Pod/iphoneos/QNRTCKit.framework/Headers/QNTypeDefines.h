...
NS_ERROR_ENUM(QNRTCErrorDomain)
{
     ...
     */
    QNRTCErrorRoomStateError                     = 11015,
...
/*!
 @typedef    QNJoinResultCallback
 @abstract   加入房间用户回调
 */
typedef void (^QNJoinResultCallback)(BOOL success, NSError *error);

/*!
 @typedef    QNPublishResultCallback
 @abstract   用户发布 track 的回调
 */
typedef void (^QNPublishResultCallback)(NSArray* onPublishedList, NSError *error);
