 ...
 * @since v4.0.0
 */
+ (QNTrack *)createCustomVideoTrackWithConfig:(QNCustomVideoTrackConfig *)configuration;

/*!
 * @abstract 获取连麦房间中的音频管理类实例
 *
 * @warning 使用方式如下：
 *          audioEngine.audioURL = [NSURL URLWithString:@"http://www.xxx.com/test.mp3"];
 ...
 * @since v4.0.0
 */
+ (void)setPreviewMirrorFrontFacing:(BOOL)previewMirrorFrontFacing;
 ...
 * @since v4.0.0
 */
+ (BOOL)getPreviewMirrorFrontFacing;
/*!
 * @abstract 后置摄像头预览是否开启镜像，默认为 NO。
 *
 * @since v4.0.0
 */
+ (void)setPreviewMirrorRearFacing:(BOOL)previewMirrorRearFacing;
 ...
 * @since v4.0.0
 */
+ (BOOL)getPreviewMirrorRearFacing;
 ...
 * @since v4.0.0
 */
+ (void)setEncodeMirrorFrontFacing:(BOOL)encodeMirrorFrontFacing;
...
+ (BOOL)getEncodeMirrorFrontFacing;
 ...
 * @since v4.0.0
 */
+ (void)setEncodeMirrorRearFacing:(BOOL)encodeMirrorRearFacing;
 ...
 * @since v4.0.0
 */
+ (BOOL)getEncodeMirrorRearFacing;
